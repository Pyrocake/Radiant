...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> SOLAR_OVEN_BLOCK = registerBlockWithItem("solar_oven_block", Solar_Oven_Block::new, () -> BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK));
