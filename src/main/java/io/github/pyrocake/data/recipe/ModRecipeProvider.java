...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        oreSmelting(recipeOutput, PRISMALLON_SMELTABLES, RecipeCategory.MISC, ModItems.PRISMALLON_INGOT.get(), 1f, 200, "prismallon_ingot");
        oreBlasting(recipeOutput, PRISMALLON_SMELTABLES, RecipeCategory.MISC, ModItems.PRISMALLON_INGOT.get(), 1f, 100, "prismallon_ingot");

        nineBlockStorageRecipes(recipeOutput, RecipeCategory.MISC, ModItems.RAW_PRISMALLON.get(), RecipeCategory.MISC, ModBlocks.RAW_PRISMALLON_BLOCK);
        ...
        nineBlockStorageRecipesWithCustomPacking(recipeOutput,
                RecipeCategory.MISC, ModItems.PRISMALLON_NUGGET,
                RecipeCategory.MISC, ModItems.PRISMALLON_INGOT,
