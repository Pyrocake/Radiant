...
public class ItemInit {
    ...
    public static final DeferredItem<Item> RAW_PRISMALLON = ITEMS.register("raw_prismallon", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> PRISMALLON_NUGGET = ITEMS.register("prismallon_nugget", () -> new Item(new Item.Properties()));
}
